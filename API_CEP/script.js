// Função que será chamada ao cricar no botão
function consultarCep(){
    //Obtém o valor do campo CEP
    const cep = document.getElementById('cep').value;

    //Verifica dr o CEP tem 8 dígitos
    if(cep.length !==8){
        alert("Por favor, insira um CEP válido com 8 dígitos.");
        return; //Interrompe a excução da função se o CEP foi inválido
...
fetch(url)
    ...
    .then(data => {
        ...
        //Atualiza os campos no formulário com os dados relacionados pela API
